...
```groovy
dependencies {
    implementation 'io.github.notablogger:spring-xpose-starter:3.0.1'
    annotationProcessor 'io.github.notablogger:spring-xpose-processor:3.0.1'
    compileOnly 'io.github.notablogger:spring-xpose-annotations:3.0.1'
